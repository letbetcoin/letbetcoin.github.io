...
Component.options.__file = "/data/data/working/circe/lbt-wallet/src/components/new-wallet/index.vue"
...
var update = __webpack_require__(12)("8dee2a74", content, false);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__create_password__ = __webpack_require__(617);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__save_keystore__ = __webpack_require__(622);
...
Component.options.__file = "/data/data/working/circe/lbt-wallet/src/components/new-wallet/create-password/index.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] index.vue: functional components are not supported with templates, they should use render functions.")}
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(12)("1057b2c8", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__services_web3__ = __webpack_require__(148);
//
//
//
//
...
Component.options.__file = "/data/data/working/circe/lbt-wallet/src/components/new-wallet/save-keystore/index.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] index.vue: functional components are not supported with templates, they should use render functions.")}
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(12)("2060cd8e", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_json_stringify__ = __webpack_require__(626);
